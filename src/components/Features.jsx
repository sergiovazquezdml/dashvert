    ...
    <section id="servicios" ref={comp} className="relative z-10 px-6 py-32 md:py-48">
      <div className="w-full max-w-7xl mx-auto">
        <h2 className="section-title text-[clamp(3rem,5vw,5.5rem)] font-black text-white leading-[0.95] tracking-tighter mb-8 w-full max-w-5xl drop-shadow-lg">
          Un asistente hiper-especializado para cada aspecto de tu vida.
        </h2>
        ...
        <div className="bento-grid grid grid-cols-1 md:grid-cols-3 grid-flow-dense gap-6">
          ...
          <div className="bento-card group col-span-1 md:col-span-2 row-span-1 bg-slate-800 rounded-3xl p-10 md:p-16 overflow-hidden relative min-h-[400px] flex flex-col justify-end">
            ...
            <h3 className="relative z-10 text-3xl md:text-5xl font-black text-white tracking-tight mb-4 drop-shadow-lg">Finanzas & Seguros</h3>
            <p className="relative z-10 text-slate-200 text-lg max-w-md font-medium drop-shadow-lg">Arturo y Mateo analizan tus declaraciones ante el SAT, pólizas médicas y deducibles para que nunca pagues de más ni te tomen por sorpresa.</p>
          </div>
          ...
          <div className="bento-card group col-span-1 md:col-span-1 row-span-2 bg-indigo-600 rounded-3xl p-10 md:p-12 overflow-hidden relative min-h-[400px] flex flex-col justify-between">
            ...
            <div className="relative z-10 text-6xl md:text-7xl font-black text-white tracking-tighter">$200</div>
            <div className="relative z-10 mt-auto">
              <h3 className="text-3xl font-black text-white tracking-tight mb-4 drop-shadow-lg">Suscripción Plana</h3>
              <p className="text-slate-200 text-base font-medium drop-shadow-lg">Acceso total al Hub de asistentes por $200 MXN mensuales. Cancela cuando quieras, sin ataduras.</p>
            </div>
          </div>
          ...
          <div className="bento-card group col-span-1 md:col-span-2 row-span-1 bg-slate-100 rounded-3xl p-10 md:p-16 overflow-hidden relative min-h-[400px] flex flex-col justify-end">
            <div className="absolute right-0 bottom-0 text-[120px] md:text-[160px] text-slate-200 font-black leading-none transform translate-y-10 group-hover:-translate-y-4 transition-transform duration-700 ease-out">24/7</div>
            <h3 className="relative z-10 text-3xl md:text-5xl font-black text-slate-950 tracking-tight mb-4">Salud & Bienestar</h3>
            <p className="relative z-10 text-slate-900 text-lg max-w-md font-medium">Sofía diseña tus rutinas. El Dr. Hugo atiende tus dudas preventivas en cualquier momento, de forma inmediata y profesional.</p>
          </div>
